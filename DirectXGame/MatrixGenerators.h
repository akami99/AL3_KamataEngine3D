...
/// <param name="translate">座標</param>
/// <returns>3次元アフィン変換行列</returns>
KamataEngine::Matrix4x4 MakeAffineMatrix(const KamataEngine::Vector3& scale, const KamataEngine::Matrix4x4& rotationMatrix, const KamataEngine::Vector3& translate);
